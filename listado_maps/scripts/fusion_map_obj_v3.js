...
GFusionMap.prototype.geeMapTileFunc = function(
  ...
  return function(coord, zoom) {
      ...
      //******************************************************************************************************************************************************//
      //********************************** Versión 4.4 cambia los valores para indicar lat, lng y zoom comparado con versión 4.1 *****************************//
      //******************************************************************************************************************************************************//
      var url = "";
      if (version == "4") {
          url = server + glmPath + '/query?request=' + request +
                    '&channel=' + channel + '&version=' + version + '&x=' + x +
                    '&y=' + coord.y + '&z=' + zoom;
      }
      else {
          url = server + glmPath + '/query?request=' + request +
                    '&channel=' + channel + '&version=' + version + '&col=' + x +
                    '&row=' + coord.y + '&level=' + zoom;
      }
      return url;
    };
};
